/*
 Fichier StaticArrayStructureReferenceDemo.cpp
 Auteur : Mattens Jean-Michel
 Programme : StaticArrayStructureReferenceDemo lit les fiches signialitiques des étudiants
...
void Purge(void);
void LireFicheEtud(TStudent& rEtud);
void LireClasse(TStudent aClasse[], int& rNbr);
void MajusculesClasse(TStudent aClasse[], int nbr);
void AffClasse(const TStudent aClasse[], int n);
//---------------------------------------------------------------------------
...
void LireFicheEtud(TStudent& rEtud) {
	cout << "\nNom :\t\t\t";
	Purge();
	cin.get(rEtud.nom, 30);
	cout << "Prénom :\t\t";
	Purge();
	cin.get(rEtud.prenom, 20);
	do {
		cout << "Sexe <M> ou <F> : \t";
		Purge();
		cin >> rEtud.sexe;
	} while ((toupper(rEtud.sexe)!='M') && (toupper(rEtud.sexe)!='F'));
	cout << "Age :\t\t\t";
	Purge();
	cin >> rEtud.age;
	cout << "Section :\t\t";
	Purge();
	cin.get(rEtud.section, 5);
}
...
void AffClasse(const TStudent aClasse[], int nbr) {
